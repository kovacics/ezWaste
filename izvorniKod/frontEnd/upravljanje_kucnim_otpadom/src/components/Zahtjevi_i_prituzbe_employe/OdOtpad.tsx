...
import {getPendingBulkyRequestForms} from "../../store/BulkyWasteResponseService";
...
export default class OdOtpad extends Component {
    state = {
        render: true,
        id: "",
        ...
        return (
            <div>
                ...
                <Form className="login100-form validate-form flex-sb flex-w">
                    <span className={"login100-form-title"}>Odgovori za odvoz glomaznog otpada</span>
                </Form>
                {this.odgovaraj ? (
